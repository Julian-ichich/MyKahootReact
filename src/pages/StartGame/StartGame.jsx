...
const StartGame = () => {
    const { count, show, setShow, myCallback } = useContext(KahootClienteContext)
    useEffect(() => {
        if (count > 0) {
    ...
    return (
        <>
            {
                show && <div className="d-flex w-100 justify-content-center align-items-center" style={{ height: 700 }}>
                    <p className="position-absolute fs-1 text-white bg-black rounded-5">{count}</p>
